                ...
                <header className="bg-[#FFF8EE] shadow-2xl	">
                    <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                        <Link to="/" className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
                         <img alt="logo" src='images/logo.png' className='object-scale-down h-12 w-96' /></Link>   
                        <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
                            ...
                            <Link className="mr-8 hover:text-gray-900 text-[#2A435D] font-bold" to='/menu'>Menu</Link>
                       ...
                       <button className="inline-flex items-center bg-[#F89808] border-0 py-1 px-3 focus:outline-none hover:bg-pink-300 rounded text-base mt-4 md:mt-0 text-white"><Link to="/login" >Login</Link> 
                        </button>
                    </div>
                </header>
            </nav>
